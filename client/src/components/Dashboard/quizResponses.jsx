...
export default function QuizResponses() {
    ...
    const { data: result, isLoading : isResultLoading, refetch: refetchResult } = useQuery({
        queryKey: ["result", quizId],
        queryFn: async () => {
            try {
                const serverResponse = await axios.post(`http://localhost:5000/response/results` , {
                    quizId : "67434d6802bb41a9a5fe790c"
                });
                console.log(serverResponse.data)
                    ...
                    <div className="w-[35%] flex flex-col gap-4 h-full">
                        ...
                        <div className="flex items-center mt-5 gap-10">
                            ...
                            <div>
                                ...
                                <h1 className="font-Satoshi-Bold text-xl">{quiz.questions.length}</h1>
                            </div>
                        </div>
                    </div>
                    <div className="w-[65%] pt-10">
                        ...
                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-5">
                            <table class="w-full text-sm text-left rtl:text-right text-black">
                                <thead class="text-xs text-black uppercase bg-[#f3f3f3] border-2">
                                    <tr>
