...
export default function QueHeader({ form, index }) {
    ...
    return (
        <div className="flex relative pt-4 font-sm font-Silka-Medium pb-4 border-b-[1.5px]" >
            <div onClick={() =>{ setShowTypes(!showTypes)}} className="flex bg-[#F3F3F3] p-2 gap-5 pl-3 h-7 pr-3 rounded-sm items-center cursor-pointer">
                <div className="text-[12px] flex gap-2"><RenderQueType iconsize={17} type={form.value} /></div>
                <motion.div
